      ...
      if(this.command(4)){
        switch(this.command(4)){
          case '-c': 
            if(this.command(5)){
              switch(this.command(5)){
                case 'h': 
                  console.log(`${this.command(3)} -c h`);
                  break;
                case 'http': 
                  console.log(`${this.command(3)} -c http`);
                  break;
                case 't': 
                  console.log(`${this.command(3)} -c t`);
                  break;
                case 'tcp': 
                  console.log(`${this.command(3)} -c tcp`);
                  break;
              default:
                console.log(Red('unrecognized command'))
                break;
          ...
          if(this.command(5)){
            switch(this.command(5)){
              case 'h': 
                console.log(`${this.command(3)} -r h`);
                break;
              case 'http': 
                console.log(`${this.command(3)} -r http`);
                break;
              case 't': 
                console.log(`${this.command(3)} -r t`);
                break;
              case 'tcp': 
                console.log(`${this.command(3)} -r tcp`);
                break;
              default:
                console.log(Red('unrecognized command'))
                break;

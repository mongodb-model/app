 ...
 */
 ...
 const {BIGreen, BIRed} = new Couleur
  ...
  makeModelCommandFour(){
    switch(this.command(4)){
      ...
      case '-r':
        ...
        break;
      default: 
        console.log(BIRed('invalid command'))
        break;
    }
  }
  makeModel() {
    if (this.command(3)) {
      if(this.command(4)){
        ...
        console.log(BIRed('unrecognized command'))
    }
  }
  ...
  async list(){
    // const {BIGreen} = new Couleur
     ...
     if(models && models.length){
      ...
      return console.log(BIGreen('There is zero model so far!'))
     }
